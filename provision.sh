...
# Install the pet site
mkdir /var/www/wisdompetmed.local
unzip /vagrant/Website_pet.zip -d /var/www/wisdompetmed.local
...
echo "YOU'LL NEVER SEE THIS!" > /var/www/wisdompetmed.local/deny/index.html
